...
class ModelComment {
    ...
    String cId, comment, timestamplate, uid, uEmail, uDp, uName;

    public ModelComment() {
    }

    public ModelComment(String cId, String comment, String timestamplate, String uid, String uEmail, String uDp, String uName) {
        this.cId = cId;
